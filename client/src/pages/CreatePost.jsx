    ...
    <section className="max-w-7xl mx-auto">
      <div>
        ...
        <p className="mt-2 text-[#666e75] text-[16px] max-w[500px]">
          ...
          image through Text2Artistry AI and share with the community
        </p>
      </div>
      ...
      <form action="" className="mt-16 max-w-3xl" onSubmit={handleSubmit}>
        <div className="flex flex-col gap-5">
          ...
          <div className="relative bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 w-[18rem] p-3 h-[18rem] flex justify-center items-center">
            {form.photo? (
              <img
                src={form.photo}
                alt={form.prompt}
          ...
          <div className="gap-5">
            <p className="mb-1 text-[#666e75] text-[14px]">
              This is s free version. So, wait for few seconds for Image generation to be completed.
            </p>
          ...
          <div className="mt-2">
            ...
            <button type="submit" className="mt-2 text-white bg-[#6469ff] font-md rounded-md text-sm w-full sm:w-auto px-5 py-2.5 text-center"> 
